  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 border border-gray-300 rounded-md shadow-md">
        ...
        <form onSubmit={formik.handleSubmit}>
            <div className="mb-4">
                <label htmlFor="username" className="block text-sm text-black font-medium ">
                Username
                </label>
                <input 
                type="text" 
                ...
                className={`mt-1 block w-full p-2 border rounded-md shadow-sm text-white ${
            ...
            <button className="w-full px-4 py-2 bg-blue-800 hover:bg-blue-900 text-white rounded-md" type="submit">
                Register
            </button>
        </form>
    </div>
